...
Below is the latest code coverage report generated by running `uv run pytest --cov=. --cov-report=term-missing`:
...
tests/api/test_account_review_api.py          63      0   100%
tests/api/test_cart_api.py                    72      0   100%
tests/api/test_catalog_api.py                 43      0   100%
tests/conftest.py                            123      0   100%
tests/e2e/pages/__init__.py                    0      0   100%
tests/e2e/pages/account_page.py               18      4    78%   32-37, 43
tests/e2e/pages/base_page.py                  19      2    89%   36, 42
tests/e2e/pages/cart_page.py                  32      6    81%   33-34, 49, 55-56, 68
tests/e2e/pages/home_page.py                  24      5    79%   29, 47-48, 54, 60
tests/e2e/pages/login_page.py                 15      3    80%   22-23, 29
tests/e2e/pages/product_page.py               24      3    88%   46, 52, 58
tests/e2e/pages/registration_page.py          44     22    50%   33-53, 59
tests/e2e/test_guest_shopping_journey.py      30      1    97%   67
tests/e2e/test_user_auth_journey.py           22      8    64%   30-51
tests/integration/test_cart_flow.py           64      0   100%
tests/smoke/test_server_health.py             56     29    48%   12-18, 29-34, 45-50, 60-67, 77-84, 94-99
tests/unit/test_account.py                    37      0   100%
tests/unit/test_cart.py                       67      0   100%
tests/unit/test_helpers.py                    45      0   100%
tests/unit/test_inventory.py                  72      0   100%
tests/unit/test_models_logic.py               41      0   100%
tests/unit/test_review.py                     53      0   100%
------------------------------------------------------------------------
TOTAL                                       1966    286    85%
```
